...
func (FeedItemValidationStatusEnum_FeedItemValidationStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_12df48581a2145cf, []int{0, 0}
}
...
func (*FeedItemValidationStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_12df48581a2145cf, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.FeedItemValidationStatusEnum_FeedItemValidationStatus", FeedItemValidationStatusEnum_FeedItemValidationStatus_name, FeedItemValidationStatusEnum_FeedItemValidationStatus_value)
	proto.RegisterType((*FeedItemValidationStatusEnum)(nil), "google.ads.googleads.v2.enums.FeedItemValidationStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/feed_item_validation_status.proto", fileDescriptor_12df48581a2145cf)
}

var fileDescriptor_12df48581a2145cf = []byte{
	// 319 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x7c, 0x90, 0x4f, 0x4a, 0x03, 0x31,
	0x14, 0xc6, 0xed, 0xd4, 0x3f, 0x98, 0x2e, 0x1c, 0x66, 0x25, 0xd2, 0x2e, 0xda, 0x03, 0x64, 0x60,
	...
	0xeb, 0xbf, 0x00, 0x00, 0x00, 0xff, 0xff, 0x0f, 0x33, 0x51, 0xb6, 0xfa, 0x01, 0x00, 0x00,
}
