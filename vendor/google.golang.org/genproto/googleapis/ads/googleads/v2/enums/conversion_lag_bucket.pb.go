...
func (ConversionLagBucketEnum_ConversionLagBucket) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_062752a1f0559bca, []int{0, 0}
}
...
func (*ConversionLagBucketEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_062752a1f0559bca, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.ConversionLagBucketEnum_ConversionLagBucket", ConversionLagBucketEnum_ConversionLagBucket_name, ConversionLagBucketEnum_ConversionLagBucket_value)
	proto.RegisterType((*ConversionLagBucketEnum)(nil), "google.ads.googleads.v2.enums.ConversionLagBucketEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/conversion_lag_bucket.proto", fileDescriptor_062752a1f0559bca)
}

var fileDescriptor_062752a1f0559bca = []byte{
	...
	0x48, 0xec, 0x6a, 0xd9, 0x55, 0x68, 0x5d, 0x88, 0x86, 0x1c, 0x44, 0x0c, 0x1d, 0x13, 0x92, 0x95,
	...
	0x83, 0xbd, 0xfb, 0x13, 0x00, 0x00, 0xff, 0xff, 0x7c, 0x58, 0x3a, 0x18, 0xae, 0x03, 0x00, 0x00,
}
