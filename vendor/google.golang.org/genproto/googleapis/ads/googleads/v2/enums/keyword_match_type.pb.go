...
func (KeywordMatchTypeEnum_KeywordMatchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a1220eb4afcbfc67, []int{0, 0}
}
...
func (*KeywordMatchTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a1220eb4afcbfc67, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.KeywordMatchTypeEnum_KeywordMatchType", KeywordMatchTypeEnum_KeywordMatchType_name, KeywordMatchTypeEnum_KeywordMatchType_value)
	proto.RegisterType((*KeywordMatchTypeEnum)(nil), "google.ads.googleads.v2.enums.KeywordMatchTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/keyword_match_type.proto", fileDescriptor_a1220eb4afcbfc67)
}

var fileDescriptor_a1220eb4afcbfc67 = []byte{
	// 317 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x7c, 0x50, 0xdd, 0x4e, 0xf2, 0x30,
	0x18, 0xfe, 0x18, 0x9f, 0x18, 0xcb, 0x81, 0xcb, 0xa2, 0x27, 0x46, 0x0e, 0xe0, 0x02, 0xba, 0x64,
	...
	0x01, 0x00, 0x00, 0xff, 0xff, 0x48, 0x5e, 0xc0, 0xf7, 0xd6, 0x01, 0x00, 0x00,
}
