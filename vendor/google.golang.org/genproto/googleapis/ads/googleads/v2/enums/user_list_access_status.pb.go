...
func (UserListAccessStatusEnum_UserListAccessStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1564d7bb66635f97, []int{0, 0}
}
...
func (*UserListAccessStatusEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_1564d7bb66635f97, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.UserListAccessStatusEnum_UserListAccessStatus", UserListAccessStatusEnum_UserListAccessStatus_name, UserListAccessStatusEnum_UserListAccessStatus_value)
	proto.RegisterType((*UserListAccessStatusEnum)(nil), "google.ads.googleads.v2.enums.UserListAccessStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/user_list_access_status.proto", fileDescriptor_1564d7bb66635f97)
}

var fileDescriptor_1564d7bb66635f97 = []byte{
	...
	0xdc, 0x9d, 0xb2, 0x92, 0x1b, 0x37, 0x84, 0x06, 0x27, 0x10, 0x92, 0x42, 0x31, 0x04, 0x35, 0x16,
	...
	0x09, 0x28, 0xb5, 0x3d, 0xaf, 0xff, 0x6d, 0xb0, 0xfb, 0x9f, 0x00, 0x00, 0x00, 0xff, 0xff, 0x25,
	0x95, 0xaf, 0xfb, 0xe0, 0x01, 0x00, 0x00,
}
