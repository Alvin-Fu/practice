...
func (CampaignExperimentTypeEnum_CampaignExperimentType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3659d4d0c98fc41e, []int{0, 0}
}
...
func (*CampaignExperimentTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3659d4d0c98fc41e, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.CampaignExperimentTypeEnum_CampaignExperimentType", CampaignExperimentTypeEnum_CampaignExperimentType_name, CampaignExperimentTypeEnum_CampaignExperimentType_value)
	proto.RegisterType((*CampaignExperimentTypeEnum)(nil), "google.ads.googleads.v2.enums.CampaignExperimentTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/campaign_experiment_type.proto", fileDescriptor_3659d4d0c98fc41e)
}

var fileDescriptor_3659d4d0c98fc41e = []byte{
	...
	0x91, 0xc2, 0xce, 0xb0, 0x71, 0x5a, 0xb7, 0xaa, 0x10, 0x21, 0xea, 0x0b, 0x04, 0x91, 0x2a, 0xd3,
	...
	0x21, 0x54, 0xdc, 0xbc, 0x1e, 0x15, 0xc5, 0xae, 0x7f, 0x02, 0x00, 0x00, 0xff, 0xff, 0xee, 0xe3,
	0x2f, 0x9c, 0xf1, 0x01, 0x00, 0x00,
}
