...
func (StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bc73f155783bec59, []int{0, 0}
}
...
func (*StructuredSnippetPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc73f155783bec59, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField", StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField_name, StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField_value)
	proto.RegisterType((*StructuredSnippetPlaceholderFieldEnum)(nil), "google.ads.googleads.v2.enums.StructuredSnippetPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/structured_snippet_placeholder_field.proto", fileDescriptor_bc73f155783bec59)
}

var fileDescriptor_bc73f155783bec59 = []byte{
	// 329 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x84, 0x50, 0xdf, 0x4a, 0xfb, 0x30,
	0x18, 0xfd, 0xb5, 0x83, 0xfd, 0x24, 0x13, 0x2c, 0xbd, 0x14, 0x77, 0xb1, 0x81, 0x5e, 0xa6, 0x50,
	...
	0xff, 0x4b, 0xdb, 0xe2, 0xd2, 0x14, 0x02, 0x00, 0x00,
}
