...
func (RecommendationTypeEnum_RecommendationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5d57f4d4a21d6733, []int{0, 0}
}
...
func (*RecommendationTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_5d57f4d4a21d6733, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.enums.RecommendationTypeEnum_RecommendationType", RecommendationTypeEnum_RecommendationType_name, RecommendationTypeEnum_RecommendationType_value)
	proto.RegisterType((*RecommendationTypeEnum)(nil), "google.ads.googleads.v2.enums.RecommendationTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/enums/recommendation_type.proto", fileDescriptor_5d57f4d4a21d6733)
}

var fileDescriptor_5d57f4d4a21d6733 = []byte{
	...
	0x54, 0x2e, 0x90, 0xc2, 0x95, 0xeb, 0x98, 0xd6, 0x6a, 0x6b, 0x5b, 0x89, 0xd3, 0x75, 0x53, 0x25,
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0xe2, 0x3a, 0xa3, 0x2e, 0x02, 0x03, 0x00, 0x00,
}
