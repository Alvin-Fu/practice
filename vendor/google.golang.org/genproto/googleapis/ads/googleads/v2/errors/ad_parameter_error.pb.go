...
func (AdParameterErrorEnum_AdParameterError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a5382df3d7f90d49, []int{0, 0}
}
...
func (*AdParameterErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a5382df3d7f90d49, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.AdParameterErrorEnum_AdParameterError", AdParameterErrorEnum_AdParameterError_name, AdParameterErrorEnum_AdParameterError_value)
	proto.RegisterType((*AdParameterErrorEnum)(nil), "google.ads.googleads.v2.errors.AdParameterErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/ad_parameter_error.proto", fileDescriptor_a5382df3d7f90d49)
}

var fileDescriptor_a5382df3d7f90d49 = []byte{
	...
	0x02, 0x71, 0x21, 0x8c, 0xab, 0x69, 0x33, 0x2d, 0xa1, 0x36, 0x09, 0x69, 0x92, 0xaa, 0x04, 0x86,
	...
	0x01, 0x00, 0x00, 0xff, 0xff, 0xe6, 0xd3, 0x5f, 0x07, 0x08, 0x02, 0x00, 0x00,
}
