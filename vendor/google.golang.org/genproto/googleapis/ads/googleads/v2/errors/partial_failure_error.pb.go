...
func (PartialFailureErrorEnum_PartialFailureError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_26f8edbddd5701b0, []int{0, 0}
}
...
func (*PartialFailureErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_26f8edbddd5701b0, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.PartialFailureErrorEnum_PartialFailureError", PartialFailureErrorEnum_PartialFailureError_name, PartialFailureErrorEnum_PartialFailureError_value)
	proto.RegisterType((*PartialFailureErrorEnum)(nil), "google.ads.googleads.v2.errors.PartialFailureErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/partial_failure_error.proto", fileDescriptor_26f8edbddd5701b0)
}

var fileDescriptor_26f8edbddd5701b0 = []byte{
	...
	0x24, 0xb8, 0x1b, 0x57, 0x53, 0x99, 0x36, 0xc4, 0x4a, 0x11, 0x05, 0x13, 0x43, 0x42, 0x46, 0xc1,
	...
	0x00, 0x00, 0xff, 0xff, 0x4a, 0xd3, 0x97, 0xeb, 0xeb, 0x01, 0x00, 0x00,
}
