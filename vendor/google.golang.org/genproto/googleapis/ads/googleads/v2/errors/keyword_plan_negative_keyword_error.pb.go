...
func (KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fb5cae318ffa1732, []int{0, 0}
}
...
func (*KeywordPlanNegativeKeywordErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_fb5cae318ffa1732, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError", KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError_name, KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError_value)
	proto.RegisterType((*KeywordPlanNegativeKeywordErrorEnum)(nil), "google.ads.googleads.v2.errors.KeywordPlanNegativeKeywordErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/keyword_plan_negative_keyword_error.proto", fileDescriptor_fb5cae318ffa1732)
}

var fileDescriptor_fb5cae318ffa1732 = []byte{
	// 297 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x84, 0x90, 0xc1, 0x4a, 0xf4, 0x30,
	0x14, 0x85, 0xff, 0xf6, 0x07, 0x85, 0xcc, 0xc2, 0xa1, 0x4b, 0x91, 0x11, 0xaa, 0xeb, 0x04, 0xea,
	...
	0xff, 0xda, 0x8c, 0x72, 0x6e, 0xfa, 0x01, 0x00, 0x00,
}
