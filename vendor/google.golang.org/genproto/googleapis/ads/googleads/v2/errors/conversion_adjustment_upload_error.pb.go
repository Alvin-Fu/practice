...
func (ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ee5155a23c3d715a, []int{0, 0}
}
...
func (*ConversionAdjustmentUploadErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ee5155a23c3d715a, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError", ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError_name, ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError_value)
	proto.RegisterType((*ConversionAdjustmentUploadErrorEnum)(nil), "google.ads.googleads.v2.errors.ConversionAdjustmentUploadErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/conversion_adjustment_upload_error.proto", fileDescriptor_ee5155a23c3d715a)
}

var fileDescriptor_ee5155a23c3d715a = []byte{
	...
	0x0a, 0x77, 0xe1, 0xca, 0x8b, 0x4f, 0x4b, 0x46, 0xe6, 0x44, 0x89, 0x93, 0x31, 0x54, 0xc9, 0x0a,
	...
	0xef, 0x00, 0x00, 0x00, 0xff, 0xff, 0x88, 0xc7, 0x26, 0xf4, 0x42, 0x03, 0x00, 0x00,
}
