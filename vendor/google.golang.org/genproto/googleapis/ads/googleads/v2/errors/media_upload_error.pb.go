...
func (MediaUploadErrorEnum_MediaUploadError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_d359659ce7747724, []int{0, 0}
}
...
func (*MediaUploadErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_d359659ce7747724, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.MediaUploadErrorEnum_MediaUploadError", MediaUploadErrorEnum_MediaUploadError_name, MediaUploadErrorEnum_MediaUploadError_value)
	proto.RegisterType((*MediaUploadErrorEnum)(nil), "google.ads.googleads.v2.errors.MediaUploadErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/media_upload_error.proto", fileDescriptor_d359659ce7747724)
}

var fileDescriptor_d359659ce7747724 = []byte{
	...
	0x11, 0xec, 0xa2, 0x30, 0x5d, 0x8d, 0x75, 0x22, 0x52, 0xff, 0x91, 0x68, 0x02, 0x45, 0x10, 0xdb,
	...
	0x58, 0x42, 0x8f, 0x7f, 0xfb, 0xe9, 0xae, 0x3f, 0x02, 0x00, 0x00, 0xff, 0xff, 0x4a, 0xee, 0xb8,
	0xf3, 0x1f, 0x02, 0x00, 0x00,
}
