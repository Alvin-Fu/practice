...
func (FieldErrorEnum_FieldError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9a726b17a04e42c0, []int{0, 0}
}
...
func (*FieldErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_9a726b17a04e42c0, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.FieldErrorEnum_FieldError", FieldErrorEnum_FieldError_name, FieldErrorEnum_FieldError_value)
	proto.RegisterType((*FieldErrorEnum)(nil), "google.ads.googleads.v2.errors.FieldErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/field_error.proto", fileDescriptor_9a726b17a04e42c0)
}

var fileDescriptor_9a726b17a04e42c0 = []byte{
	...
	0x70, 0x50, 0xd8, 0x99, 0x95, 0x93, 0xb8, 0x23, 0xab, 0x89, 0x1b, 0x9a, 0x3f, 0x08, 0x14, 0xc9,
	...
	0xf0, 0xed, 0xc7, 0x5b, 0x44, 0x02, 0x00, 0x00,
}
