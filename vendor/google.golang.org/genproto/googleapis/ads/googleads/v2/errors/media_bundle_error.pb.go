...
func (MediaBundleErrorEnum_MediaBundleError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_3ef7e4b3381ea556, []int{0, 0}
}
...
func (*MediaBundleErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_3ef7e4b3381ea556, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.MediaBundleErrorEnum_MediaBundleError", MediaBundleErrorEnum_MediaBundleError_name, MediaBundleErrorEnum_MediaBundleError_value)
	proto.RegisterType((*MediaBundleErrorEnum)(nil), "google.ads.googleads.v2.errors.MediaBundleErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/media_bundle_error.proto", fileDescriptor_3ef7e4b3381ea556)
}

var fileDescriptor_3ef7e4b3381ea556 = []byte{
	...
	0x1b, 0x88, 0x88, 0xb0, 0x5e, 0xcd, 0x66, 0x4f, 0xb6, 0x43, 0x67, 0x67, 0xd6, 0x99, 0xd9, 0xa4,
	...
	0xa4, 0xbb, 0x0f, 0x7f, 0x03, 0x00, 0x00, 0xff, 0xff, 0xa0, 0x2b, 0x0f, 0x9a, 0x2d, 0x04, 0x00,
	0x00,
}
