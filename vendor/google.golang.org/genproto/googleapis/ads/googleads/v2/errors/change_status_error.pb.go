...
func (ChangeStatusErrorEnum_ChangeStatusError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7e903bf4c0349481, []int{0, 0}
}
...
func (*ChangeStatusErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_7e903bf4c0349481, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.ChangeStatusErrorEnum_ChangeStatusError", ChangeStatusErrorEnum_ChangeStatusError_name, ChangeStatusErrorEnum_ChangeStatusError_value)
	proto.RegisterType((*ChangeStatusErrorEnum)(nil), "google.ads.googleads.v2.errors.ChangeStatusErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/change_status_error.proto", fileDescriptor_7e903bf4c0349481)
}

var fileDescriptor_7e903bf4c0349481 = []byte{
	...
	0x80, 0xdd, 0x94, 0xe9, 0x6a, 0x12, 0x6d, 0x90, 0x16, 0x95, 0x6a, 0x2c, 0x14, 0x41, 0x26, 0x51,
	...
	0xfc, 0x57, 0xed, 0x6e, 0xbe, 0x03, 0x00, 0x00, 0xff, 0xff, 0xd2, 0xd8, 0xe1, 0xa9, 0xd8, 0x01,
	0x00, 0x00,
}
