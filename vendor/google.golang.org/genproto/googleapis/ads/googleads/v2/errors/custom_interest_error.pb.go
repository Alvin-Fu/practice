...
func (CustomInterestErrorEnum_CustomInterestError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_08f77b2aa98e1ebb, []int{0, 0}
}
...
func (*CustomInterestErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_08f77b2aa98e1ebb, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v2.errors.CustomInterestErrorEnum_CustomInterestError", CustomInterestErrorEnum_CustomInterestError_name, CustomInterestErrorEnum_CustomInterestError_value)
	proto.RegisterType((*CustomInterestErrorEnum)(nil), "google.ads.googleads.v2.errors.CustomInterestErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v2/errors/custom_interest_error.proto", fileDescriptor_08f77b2aa98e1ebb)
}

var fileDescriptor_08f77b2aa98e1ebb = []byte{
	...
	0x3b, 0x1b, 0xbc, 0x3b, 0xed, 0x4a, 0xb1, 0xbe, 0xa4, 0x62, 0xb1, 0x6c, 0xfc, 0xaf, 0xeb, 0x08,
	...
	0xdd, 0xc7, 0x7f, 0x01, 0x00, 0x00, 0xff, 0xff, 0x8c, 0x91, 0x24, 0x0d, 0xd4, 0x02, 0x00, 0x00,
}
