...
func (KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_89101d9415c04e8d, []int{0, 0}
}
...
func (*KeywordPlanIdeaErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_89101d9415c04e8d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/keyword_plan_idea_error.proto", fileDescriptor_89101d9415c04e8d)
}

var fileDescriptor_89101d9415c04e8d = []byte{
