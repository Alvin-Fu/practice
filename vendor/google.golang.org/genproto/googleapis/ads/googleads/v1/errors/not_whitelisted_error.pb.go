...
func (NotWhitelistedErrorEnum_NotWhitelistedError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ab1b61d03e1a79b2, []int{0, 0}
}
...
func (*NotWhitelistedErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ab1b61d03e1a79b2, []int{0}
}
...
func init() {
	proto.RegisterEnum("google.ads.googleads.v1.errors.NotWhitelistedErrorEnum_NotWhitelistedError", NotWhitelistedErrorEnum_NotWhitelistedError_name, NotWhitelistedErrorEnum_NotWhitelistedError_value)
	proto.RegisterType((*NotWhitelistedErrorEnum)(nil), "google.ads.googleads.v1.errors.NotWhitelistedErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/not_whitelisted_error.proto", fileDescriptor_ab1b61d03e1a79b2)
}

var fileDescriptor_ab1b61d03e1a79b2 = []byte{
	...
	0x42, 0x70, 0x37, 0xae, 0xd2, 0x76, 0xda, 0x06, 0x35, 0x29, 0x4d, 0xd2, 0x82, 0x04, 0x86, 0xd4,
	...
	0xff, 0xff, 0x38, 0x0c, 0xfb, 0x94, 0xf7, 0x01, 0x00, 0x00,
}
