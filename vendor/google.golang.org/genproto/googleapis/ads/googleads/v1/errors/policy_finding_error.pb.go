...
func (PolicyFindingErrorEnum_PolicyFindingError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_61987e2d3d600b4b, []int{0, 0}
}
...
func (*PolicyFindingErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_61987e2d3d600b4b, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/policy_finding_error.proto", fileDescriptor_61987e2d3d600b4b)
}

var fileDescriptor_61987e2d3d600b4b = []byte{
