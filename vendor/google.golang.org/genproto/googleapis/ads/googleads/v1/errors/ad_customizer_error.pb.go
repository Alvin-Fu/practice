...
func (AdCustomizerErrorEnum_AdCustomizerError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ad09816fa1689384, []int{0, 0}
}
...
func (*AdCustomizerErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad09816fa1689384, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/ad_customizer_error.proto", fileDescriptor_ad09816fa1689384)
}

var fileDescriptor_ad09816fa1689384 = []byte{
