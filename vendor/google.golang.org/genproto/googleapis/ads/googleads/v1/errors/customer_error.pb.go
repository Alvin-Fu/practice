...
func (CustomerErrorEnum_CustomerError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_307d1dd8bdad6a5d, []int{0, 0}
}
...
func (*CustomerErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_307d1dd8bdad6a5d, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/customer_error.proto", fileDescriptor_307d1dd8bdad6a5d)
}

var fileDescriptor_307d1dd8bdad6a5d = []byte{
