...
func (InternalErrorEnum_InternalError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9b8dc486f08daaa1, []int{0, 0}
}
...
func (*InternalErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_9b8dc486f08daaa1, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/internal_error.proto", fileDescriptor_9b8dc486f08daaa1)
}

var fileDescriptor_9b8dc486f08daaa1 = []byte{
