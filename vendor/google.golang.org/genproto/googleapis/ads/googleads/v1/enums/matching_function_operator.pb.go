...
func (MatchingFunctionOperatorEnum_MatchingFunctionOperator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_783bfd6aa74ae209, []int{0, 0}
}
...
func (*MatchingFunctionOperatorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_783bfd6aa74ae209, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/matching_function_operator.proto", fileDescriptor_783bfd6aa74ae209)
}

var fileDescriptor_783bfd6aa74ae209 = []byte{
