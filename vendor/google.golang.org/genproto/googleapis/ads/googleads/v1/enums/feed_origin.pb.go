...
func (FeedOriginEnum_FeedOrigin) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a0e878bed3b5bcf6, []int{0, 0}
}
...
func (*FeedOriginEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a0e878bed3b5bcf6, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/feed_origin.proto", fileDescriptor_a0e878bed3b5bcf6)
}

var fileDescriptor_a0e878bed3b5bcf6 = []byte{
