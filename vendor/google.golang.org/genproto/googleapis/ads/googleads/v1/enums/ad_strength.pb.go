...
func (AdStrengthEnum_AdStrength) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f6be2a2119b3f8e8, []int{0, 0}
}
...
func (*AdStrengthEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6be2a2119b3f8e8, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/ad_strength.proto", fileDescriptor_f6be2a2119b3f8e8)
}

var fileDescriptor_f6be2a2119b3f8e8 = []byte{
