...
func (AppStoreEnum_AppStore) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_6f2edfdc6e3ce9d3, []int{0, 0}
}
...
func (*AppStoreEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f2edfdc6e3ce9d3, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/app_store.proto", fileDescriptor_6f2edfdc6e3ce9d3)
}

var fileDescriptor_6f2edfdc6e3ce9d3 = []byte{
