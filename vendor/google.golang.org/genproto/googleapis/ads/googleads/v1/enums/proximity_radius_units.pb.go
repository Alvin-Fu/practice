...
func (ProximityRadiusUnitsEnum_ProximityRadiusUnits) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_deffb3e711c9fade, []int{0, 0}
}
...
func (*ProximityRadiusUnitsEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_deffb3e711c9fade, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/proximity_radius_units.proto", fileDescriptor_deffb3e711c9fade)
}

var fileDescriptor_deffb3e711c9fade = []byte{
