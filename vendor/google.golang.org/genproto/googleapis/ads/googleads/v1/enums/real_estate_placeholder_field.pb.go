...
func (RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_55a569651ed4e6a3, []int{0, 0}
}
...
func (*RealEstatePlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_55a569651ed4e6a3, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/real_estate_placeholder_field.proto", fileDescriptor_55a569651ed4e6a3)
}

var fileDescriptor_55a569651ed4e6a3 = []byte{
