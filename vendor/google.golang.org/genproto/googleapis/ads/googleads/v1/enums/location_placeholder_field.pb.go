...
func (LocationPlaceholderFieldEnum_LocationPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_a7365260cf440eb7, []int{0, 0}
}
...
func (*LocationPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7365260cf440eb7, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/location_placeholder_field.proto", fileDescriptor_a7365260cf440eb7)
}

var fileDescriptor_a7365260cf440eb7 = []byte{
