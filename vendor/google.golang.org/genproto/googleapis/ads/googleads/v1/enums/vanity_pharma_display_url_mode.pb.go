...
func (VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_7fd43ea3416edbfd, []int{0, 0}
}
...
func (*VanityPharmaDisplayUrlModeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_7fd43ea3416edbfd, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/vanity_pharma_display_url_mode.proto", fileDescriptor_7fd43ea3416edbfd)
}

var fileDescriptor_7fd43ea3416edbfd = []byte{
