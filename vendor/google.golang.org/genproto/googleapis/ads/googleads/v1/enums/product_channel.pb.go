...
func (ProductChannelEnum_ProductChannel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1a8696547f984201, []int{0, 0}
}
...
func (*ProductChannelEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_1a8696547f984201, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/product_channel.proto", fileDescriptor_1a8696547f984201)
}

var fileDescriptor_1a8696547f984201 = []byte{
