...
func (LocalPlaceholderFieldEnum_LocalPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0dcff458a17bffef, []int{0, 0}
}
...
func (*LocalPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_0dcff458a17bffef, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/local_placeholder_field.proto", fileDescriptor_0dcff458a17bffef)
}

var fileDescriptor_0dcff458a17bffef = []byte{
